...
public class PQ_UsingBinaryHeap {
    ...
    public static void main(String[] args) {
        ...
        changePriority(2, 49);
        System.out.print("Priority queue after priority change to 49: ");
        int k = 0;
        while (k <= size) {
        ...
        remove(3);
        System.out.print("Priority queue after removing the element 3: ");
        int l = 0;
        while (l <= size) {
